...
export default function Home() {
  ...
  return (
    <HomeContainer>
      ...
      This means every game is different, with fresh challenges every time you play! 
      You can give the AI instructions to better tailor your experience, such as 
      give it categories to create questions for, or give it the context for the quiz.
